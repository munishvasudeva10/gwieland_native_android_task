...
@Composable
fun WalletView(navController: NavHostController, vm: WalletVM = hiltViewModel()) {
    Scaffold(
        topBar = {
            MainTopBar(stringResource(R.string.wallet))
        },
        ...
        Column(
            ...
            Text(text = stringResource(R.string.wallet_page), color = Color.Gray)
        }
    }
